...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AMORTIZATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AMORTIZATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AMORTIZATION actions', async () => {
      const arg = { id: 3679 };
    ...
    it('dispatches UPDATE_AMORTIZATION actions', async () => {
      const arg = { id: 3679 };
    ...
    it('dispatches PARTIAL_UPDATE_AMORTIZATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AMORTIZATION actions', async () => {
      const arg = 42666;
