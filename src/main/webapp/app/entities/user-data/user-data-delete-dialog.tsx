...
export const UserDataDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.userData.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.userData.delete.question" interpolate={{ id: userDataEntity.id }}>
